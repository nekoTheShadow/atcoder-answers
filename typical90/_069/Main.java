...
public class Main {
    public void exec() {
        ...
        if (k == 1) {
            stdout.println(n==1 ? 1 : 0);
            return ;
        }
        
        if (n==1) {
            stdout.println(k%1000000007);
        } else if (n==2) {
            stdout.println(k*(k-1)%1000000007);
        } else {
            stdout.println((k*(k-1)%1000000007)*modPow(k-2, n-2, 1000000007)%1000000007);
        }
