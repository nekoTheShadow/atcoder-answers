...
public class Main {
    public void exec() {
        ...
        while (q-- > 0) {
            ...
            double sx = 0;
            double sy = -(l/2) * Math.sin(rad(360*e/t));
            double sz = (l/2)-(l/2) * Math.cos(rad(360*e/t));
            
            double a = Math.sqrt(x*x + (sy - y)*(sy - y));
            double b = sz;
            stdout.println(deg(Math.atan2(b, a)));
        }
    }
