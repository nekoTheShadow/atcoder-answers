...
public class Main {
    public void exec() {
        ...
        Map<Long, Long> d = Arrays.stream(a).boxed().collect(Collectors.groupingBy(Function.identity(), Collectors.counting()));
        List<Long> keys = d.keySet().stream().sorted().collect(Collectors.toList());
