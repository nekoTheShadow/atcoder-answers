...
public class Main {
    public void exec() {
        ...
        while (q-- > 0) {
            ...
            if (query == 1) {
                ...
                if (x%2==0) {
                    if (c[x]-oddSum-a >= 0) {
                        ans += a;
                        c[x] -= a;
                        oddMin = Math.min(oddMin, c[x]);
                    }
                } else {
                    if (c[x]-evenSum-a >= 0) {
                        ans += a;
                        c[x] -= a;
                        evenMin = Math.min(evenMin, c[x]);
                    }
                }
            }
            ...
            if (query == 2) {
                long a = stdin.nextLong();
                if (oddMin-oddSum-a >= 0) {
                    ans += a * (n%2==0 ? n/2 : n/2+1);
                    oddSum += a;
                }
            }
            ...
            if (query == 3) {
                long a = stdin.nextLong();
                if (oddMin-oddSum-a>=0 && evenMin-evenSum-a >= 0) {
                    ans += a*n;
                    evenSum += a;
                    oddSum += a;
                }
