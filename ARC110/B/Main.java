...
public class Main {
    public void exec() {
        ...
        if (t.equals("0") || t.equals("11")) {
            stdout.println(base);
        } else if (t.equals("01")) {
            stdout.println(base-1);
        } else if (t.equals("1")) {
            stdout.println(base*2);
        } else {
            int c = n%3==0 ? n/3 : n/3+1;

            String s = "110".repeat(c);
            if (s.contains(t)) {
                stdout.println(base-c+1);
                return ;
            }

            s += "110";
            if (s.contains(t)) {
                stdout.println(base-c);
            } else {
                stdout.println(0);
            }
        }
